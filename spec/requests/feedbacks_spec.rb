...
RSpec.describe "/posts/:post_slug/feedbacks" do
  ...
  let(:valid_attributes) { { user_id: user.id, body: "MyFeedbackBody" } }
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Feedback" do
        expect do post post_feedbacks_url(blog_post), params: { feedback: valid_attributes } end.to change(
          Feedback,
          :count
        ).by(1)
      end
    ...
    context "with invalid parameters" do
      it "does not create a new Feedback" do
        expect do post post_feedbacks_url(blog_post), params: { feedback: invalid_attributes } end.not_to change(
          Feedback,
          :count
        )
      end
